...
import app.commerceio.spring.data.search.mongo.demo.customer.Customer;
import app.commerceio.spring.data.search.mongo.demo.customer.CustomerMapper;
import app.commerceio.spring.data.search.mongo.demo.customer.CustomerRepository;
